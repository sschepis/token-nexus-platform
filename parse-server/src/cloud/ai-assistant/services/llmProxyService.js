// parse-server/src/cloud/ai-assistant/services/llmProxyService.js
...
class LLMProxyService {
   ...
   */
  async getLLMCompletion(prompt, userContext, tools, schemas) {
   ...
   */
  async getLLMResponseAfterToolExecution(originalPrompt, toolCall, toolResult, userContext, tools) {
...
module.exports = { LLMProxyService };