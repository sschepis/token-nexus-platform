// Platform setup cloud functions

/**
 * Complete initial platform setup
 * Creates admin user, parent organization, and sets up initial configuration
 */
Parse.Cloud.define('completeInitialPlatformSetup', async (request) => {
  ...
  try {
    ...
    user.set('isAdmin', true); // Use single admin flag
    ...
    savedUser.set('currentOrganizationId', savedOrg.id);
