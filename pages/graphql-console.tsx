...
const GraphQLConsolePage = () => {
  ...
  const handleExecute = async () => {
    ...
    try {
      ...
      const res = await fetch(endpoint, { // Renamed response to res to avoid conflict
        method: "POST",
        headers: {
      ...
      const data = await res.json(); // Use res here
...
export default GraphQLConsolePage;