...
const Objects: React.FC = () => {
  ...
  const handleCreateRecord = (objectId: string) => {
    ...
    // Set the selected object and navigate to records tab with create mode
    setSelectedObjectId(objectId);
    setActiveTab("records");
  };

  const handleManageObject = (objectId: string) => {
    // Navigate to the Object Manager with the specific object selected
    navigate(`/object-manager?objectId=${objectId}`);
  };
      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          ...
          <div className="flex gap-2">
            ...
            />
            <Button onClick={() => navigate("/object-manager")}>
